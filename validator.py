...
def run_validation(ce_data, pe_data, index_data):
    ...
    meta_data = {
        ...
        "ce_min_time": df_ce['entry_time'].min().strftime("%d-%m-%Y") if not df_ce.empty else None,
        "ce_max_time": df_ce['entry_time'].max().strftime("%d-%m-%Y") if not df_ce.empty else None,
        "pe_min_time": df_pe['entry_time'].min().strftime("%d-%m-%Y") if not df_pe.empty else None,
        "pe_max_time": df_pe['entry_time'].max().strftime("%d-%m-%Y") if not df_pe.empty else None,
        "index_min_time": df_index['entry_time'].min().strftime("%d-%m-%Y") if not df_index.empty else None,
        "index_max_time": df_index['entry_time'].max().strftime("%d-%m-%Y") if not df_index.empty else None,
